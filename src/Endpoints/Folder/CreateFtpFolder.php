...
/**
 * @link https://api.cloudycdn.services/api/v5/docs#/operations/Folder/Createftpfolder
 */
class CreateFtpFolder extends AbstractEndpoint implements EndpointContract
{
